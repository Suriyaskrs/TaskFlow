 ...
 *   4. Sets authenticated user in SecurityContext
 *
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // No token or wrong format → skip to next filter
        ...
        // Only authenticate if email found and no existing auth in context
